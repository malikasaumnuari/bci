          ...
          <div class="">
            ...
            <div class="x_title">
              ...
              <ul class="list-unstyled">
                <li>
                  <a href="userprofile.php" type="button" class="btn btn-default col-md-12 col-sm-12 col-xs-12" >User Profile</a>
                </li>
                <li>
                          ...
                          <div class="well profile_view">
                            <div class="col-sm-12">
                              <div class="left col-xs-7">
                                <h2>Dramaga Golf Club</h2>
                                <p><strong>About: </strong> Klub golf dramaga paling ntap </p>
                                <ul class="list-unstyled">
                                  <li> Admin: <a href="#">tigerbalm</a></li>
                                  <li> Kategori: Sports </li>
                                  <li><i class="fa fa-user"></i> 111 </li>
                                </ul>
                              </div>
                            ...
                            <div class="col-xs-12 bottom text-center">
                                ...
                                View Community </a>
                                <a type="button" class="btn btn-danger btn-xs" href="f-j-commu.html">
                                 Leave</a>
                            </div>
                          </div>
                  </div>
