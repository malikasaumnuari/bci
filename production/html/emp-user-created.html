              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/user.png" alt="">AAAA
          ...
          <div class="">
            ...
            <div class="row">
                  ...
                  <div class="col-md-4 col-sm-6 col-xs-12">
                    ...
                    <div class="profile_img" align="center" col-md-4 col-sm-6 col-xs-6>
                        <div id="crop-avatar">
                          <!-- Current avatar -->
                          <img src="images/user.png" alt="AAAA-user" col-md-4 col-sm-6 col-xs-6>
                        </div>
                      </div>
            ...
            <div class="x_title">
              ...
              <ul class="list-unstyled">
                <li>
                  <a href="user-profile.html" type="button" class="btn btn-default col-md-12 col-sm-12 col-xs-12" >User Profile</a>
                </li>
                <li>
...
<!--content-->
                ...
                <div class="x_panel">
                  ...
                  <div class="row">
                    <br>
                    <h1 align="center" style="font-size:100px"> OOPS! </h1>
                    <br>
                    <p align="center"> You haven't created any community!
                      <br>
                      <a href="f-n-commu.html"> Create a community? </a>
                    </p>
                    <br>
                    <br>
                    <br>
