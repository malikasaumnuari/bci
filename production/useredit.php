              ...
              <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <ul class="list-unstyled user_data">
                        ...
                        <li>
                          <div class="form-group col-md-12 col-sm-12 col-xs-12">
                              ...
                              <div class="col-md-8 col-sm-8 col-xs-12">
                                <input type="date" id="birthday" class="form-control col-md-7 col-xs-12">
                              </div>
                            </div>
                        </li>
                        ...
                        <li>
                          <div class="form-group col-md-12 col-sm-12 col-xs-12">
                              ...
                              <div id="gender" class="col-md-6 col-sm-6 col-xs-12" name="gender">
                        ...
                        <li>
                          <div class="form-group col-md-12 col-sm-12 col-xs-12">
                              ...
                              <div class="col-md-8 col-sm-8 col-xs-12">
                                <input type="email" id="email" class="form-control col-md-7 col-xs-12">
                              </div>
                            </div>
                        </li>
                        ...
                        <li>
                          <div class="form-group col-md-12 col-sm-12 col-xs-12">
                              ...
                              <div class="col-md-8 col-sm-8 col-xs-12">
                                <input type="text" id="contact" class="form-control col-md-7 col-xs-12">
                              </div>
                            </div>
                        </li>
                ...
                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <ul class="list-unstyled user_data">
                              <li>
                                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                    <label class="control-label col-md-4 col-sm-4 col-xs-12" for="name"><h4>Current Password</h4>
                                    </label>
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                              ...
                              <li>
                                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                    <label class="control-label col-md-4 col-sm-4 col-xs-12" for="name"><h4>New Password</h4>
                                    </label>
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                      <input type="password" id="name" class="form-control col-md-7 col-xs-12">
                                    </div>
